...
const FeedView = function() {
  return <Feed store={feedStore} />;
};

const PostView = ({ match }) => {
  const id = match.params.postId;
  return <Post id={id} store={feedStore} />;
};
const ProfileView = () => <Profile user={feedStore.user} />;
const NewPost = () => <FeedItemNew store={feedStore} />;
const LoginView = () => <Login current_user={feedStore.user} />;
        ...
        <Router>
          <div className="App">
            <div className="App-header">
              <NavLink to="/">Dads on Parenting</NavLink>
